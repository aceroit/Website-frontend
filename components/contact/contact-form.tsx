        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="space-y-3">
            ...
            >
              <SelectTrigger
                id="purpose"
                className={cn("h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg", errors.purpose && "border-destructive")}
              >
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="space-y-3 sm:col-span-2">
              ...
              <Input
                ...
                className={cn("h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg", errors.fullName && "border-destructive")}
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                className="h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg"
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                className={cn("h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg", errors.mobileNumber && "border-destructive")}
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                className={cn("h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg", errors.email && "border-destructive")}
            ...
            <div className="space-y-3">
              ...
              >
                <SelectTrigger
                  id="country"
                  className={cn("h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg", errors.country && "border-destructive")}
                >
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="space-y-3">
              ...
              >
                <SelectTrigger id="countryCode" className="h-14 border-2 bg-card text-base shadow-md transition-all hover:border-steel-red/30 hover:shadow-lg">
